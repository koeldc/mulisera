...
class EnglishGerman(nn.Module):
	def __init__(self, english_encoder, german_encoder, config):
        super(EnglishGerman, self).__init__()
        self.EnglishEncoder = english_encoder
        self.GermanEncoder = german_encoder
